import { CommonProps } from '@wg-plus/components/cascader-panel'
import { buildProps, definePropType, isBoolean } from '@wg-plus/utils'
import { useSizeProp } from '@wg-plus/hooks'
import { useTooltipContentProps } from '@wg-plus/components/tooltip'
import { tagProps } from '@wg-plus/components/tag'
import { CHANGE_EVENT, UPDATE_MODEL_EVENT } from '@wg-plus/constants'
import type {
  CascaderNode,
  CascaderValue,

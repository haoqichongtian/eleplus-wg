...
import { useLocale } from '@wg-plus/hooks'
import Chinese from '@wg-plus/locale/lang/zh-cn'
import English from '@wg-plus/locale/lang/en'
import { ElButton, ElMessage } from '@wg-plus/components'
...
import type { Language } from '@wg-plus/locale'

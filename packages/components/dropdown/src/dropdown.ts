// @ts-nocheck
import { buildProps, definePropType, iconPropType } from '@wg-plus/utils'
import { EVENT_CODE } from '@wg-plus/constants'
import { createCollectionWithScope } from '@wg-plus/components/collection'
import {
  useTooltipContentProps,
  useTooltipTriggerProps,
} from '@wg-plus/components/tooltip'

import type { Options } from '@popperjs/core'
import type { ButtonProps, ButtonType } from '@wg-plus/components/button'
import type { Placement } from '@wg-plus/components/popper'
import type { ComponentInternalInstance, ComputedRef } from 'vue'
import type { Nullable } from '@wg-plus/utils'
